    ...
    <div className="fixed top-4 inset-x-0 z-50 flex justify-center px-4 pointer-events-none">
      <div className="pointer-events-auto w-full max-w-3xl">
        ...
        <nav
          ...
          style={NAV_STYLE}
        >
          <span className="font-pixel text-xs tracking-[0.25em] text-black/70">ARCITTANCE</span>
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/app"
              className="text-[11px] px-4 py-2 rounded-xl bg-[#111] text-white hover:bg-[#333] transition-all duration-200 tracking-wide hidden md:block"
          ...
          >
            ...
            <div className="mt-1 px-2 pb-1">
              <Link
                href="/app"
                onClick={close}
                className="block w-full text-center text-[11px] px-4 py-2.5 rounded-xl bg-[#111] text-white hover:bg-[#333] transition-all duration-200 tracking-wide"
                style={{ fontFamily: "system-ui, -apple-system, sans-serif" }}
              >
                OPEN APP
              </Link>
