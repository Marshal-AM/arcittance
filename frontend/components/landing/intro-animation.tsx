...
const LETTERS = ["A", "R", "C", "I", "T", "T", "A", "N", "C", "E"]

const LETTER_IN_STAGGER  = 70    // ms between each letter appearing
...
const LETTER_OUT_STAGGER = 45    // ms between each letter disappearing
